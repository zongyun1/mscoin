module.exports = {
    ...
    sectionPage: {
        ...
        brandDesc1: "我们于2009年4月在美国纽约创办了mscoin众筹网站，致力于支持和激励具有创新性、创意性的活动，通过众筹让有创造力的人获得所需要的资金，助他们实现梦想。2010年荣获时代周刊最佳发明奖，2011年时代周刊授予最佳网站称号，2014年获得B Corp认证，2015年从传统盈利企业成为Public-Benefit Corporation（PBC）",
        brandDesc2: "2020年COVID-19全球的爆发，华裔创始人Jarno Huo 及其团队在众多国际公益组织的支持下创立了MSCOIN公益交易所， 其充分利用区块链技术的可溯源、不可篡改、数据加密安全等特征，在全球范围内建立起一套更为公开、透明、简单、高效的慈善货币及慈善金融基础设施，实现公益慈善过程中信息与行为的全流程存证、全周期的追溯与审计，以实现点对点帮助疫情中受到灾难的人们，让世界各地的人们过上更美好的生活。",
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归MSCOIN官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（www.MSCOIN.com）",
        tipsmobile1: "请在电脑端打开（www.MSCOIN.com）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        ruleprofile1:"MSCOIN的【全球传递爱】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与MSCOIN交易平台共同成长的红利！具体细则如下：",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由MSCOIN官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归MSCOIN.COM所有。",
        pt_card_day: "天",
    ...
    description: {
        ...
        // message3: 'MSCOIN数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '金融级安全',
        title2: '极速充提',
        title3: '全球服务',
        title4: '严选资产',
        ...
        message5: 'MSCOIN国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "我们于2009年4月在美国纽约创办了mscoin众筹网站，致力于支持和激励具有创新性、创意性的活动，通过众筹让有创造力的人获得所需要的资金，助他们实现梦想。2010年荣获时代周刊最佳发明奖，2011年时代周刊授予最佳网站称号，2014年获得B Corp认证，2015年从传统盈利企业成为Public-Benefit Corporation（PBC）",
        aboutdesc2: "2020年COVID-19全球的爆发，华裔创始人Jarno Huo 及其团队在众多国际公益组织的支持下创立了MSCOIN公益交易所， 其充分利用区块链技术的可溯源、不可篡改、数据加密安全等特征，在全球范围内建立起一套更为公开、透明、简单、高效的慈善货币及慈善金融基础设施，实现公益慈善过程中信息与行为的全流程存证、全周期的追溯与审计，以实现点对点帮助疫情中受到灾难的人们，让世界各地的人们过上更美好的生活。",
        aboutdesc3: "MSCOIN为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "MSCOIN严格筛选优质项目并提供安全稳定的资产托管服务。MSCOIN秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
        ...
        community: "MSCOIN社区",
        wechat: "微信",
        addwechat: "添加 “MSCOIN01” 为微信好友，进入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        telegram: "电报",
    ...
    bzb_description: {
        ...
        desc4: "参与MSCOIN社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "MSCOIN账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于MSCOIN收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，MSCOIN会拿出平台的80% (扣除税费后) 的收入分配给MSCOIN持有者，20%的收入用来支持平台的研发及运营。",
