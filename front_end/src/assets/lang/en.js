module.exports = {
    ...
    header: {
        ...
        ctc: "C2C Exchange",
        labdetail: "mscoin Lab  ●  Sharing innovation results",
    ...
    sectionPage: {
        ...
        baseexchangetips: "How to buy and sell on MSCOIN",
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by MSCOIN, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of MSCOIN.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.MSZLU.COM）",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with MSCOIN trading platform. Detailed rules are as follows:",
        ruleprofile2:"The highest rebate ratio",
        ruleprofile3:"The longest rebate period (maximum lifetime rebate)",
        ruleprofile4:"The promotion activities, so that the promoters who have made corresponding efforts can become platform partners in the true sense, and enjoy the bonus of growing together with the MSCOIN trading platform! The specific rules are as follows:",
        ...
        ruletext8: "8、TOP10 or TOP100 will be awarded additional incentives by MSCOIN from time to time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to MSCOIN.",
        ...
        thanks: "Thank you for supporting MSCOIN！",
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@MSZLU.COM, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to MSZLU.COM.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become MSCOIN Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "MSCOIN APP - Trade everywhere."
    },
    crowdfunding: {
    ...
    description: {
        ...
        aboutdesc1: "We established the mscoin crowdfunding website in New York, USA in April 2009. We are committed to supporting and motivating innovative and creative activities. Through crowdfunding, we allow creative people to get the funds they need and help them realize their dreams. In 2010, he won the Best Invention Award from Time Magazine. In 2011, Time Magazine awarded the title of Best Website. In 2014, he was certified by B Corp. In 2015, he became a Public-Benefit Corporation (PBC) from a traditional profitable company. The Chinese founder Perry Chen and his team founded the mscoin charity exchange with the support of many international charity organizations. It makes full use of the features of blockchain technology such as traceability, non-tampering, and data encryption security to establish a global Set a more open, transparent, simple and efficient charity currency and charity financial infrastructure to realize the full-process storage of information and behaviors in the charity process, full-cycle traceability and audit, so as to achieve point-to-point assistance to people affected by disasters in the epidemic , Let people all over the world live a better life.",
        aboutdesc2: "With the global outbreak of COVID-19 in 2020, Chinese founder Perry Chen and his team founded the MSCOIN charity exchange with the support of many international charity organizations, which make full use of the traceability, immutability, and data encryption security of blockchain technology. Characteristic, a more open, transparent, simple, and efficient charity currency and charity financial infrastructure have been established on a global scale to realize the full-process storage of information and behaviors in the process of charity and the full-cycle traceability and audit. Achieve point-to-point assistance to people affected by the epidemic, so that people all over the world can live a better life.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, MSZLU.COM adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "MSZLU.COM strictly screens high-quality projects and provides secure and stable asset hosting services. MSZLU.COM upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
        ...
        apply: "Board Apply",
        coop: "Cooperation",
        community: "MSCOIN Community",
        wechat: "Wechat",
        addwechat: "Add 'MSCOIN01' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        BHBregister: "MSCOIN account registration",
        ...
        fenpeijizhi: 'A description of the MSCOIN income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, MSCOIN will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
