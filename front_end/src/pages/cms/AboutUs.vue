    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.service')}}：service@MSZLU.COM</p>
          <p>{{$t('description.support')}}：support@MSZLU.COM</p>
          <p>{{$t('description.apply')}}：apply@MSZLU.COM</p>
          <p>{{$t('description.report')}}：ceo@MSZLU.COM</p>
          <p>{{$t('description.coop')}}：coop@MSZLU.COM</p>
        </div>
      </div>
    </div>
  </div>
