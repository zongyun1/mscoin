  ...
  <div class="login_form">
    ...
    <div class="login_right">
      ...
      <Alert v-else type="warning">
        Coming soon!
        <template slot="desc">
          MSZLU.COM will open register soon
        </template>
      </Alert>
    </div>
  </div>
...
export default {
  ...
  methods: {
          ...
          if (this.agree == true) {
            if (this.changeActive == 1) {
              ...
              if (this.isRegister) {
                ...
                params["captcha"] = this.captchaObj;
				
                this.$http
                  .post(this.host + "/uc/register/phone", JSON.stringify(params))
                  .then(response => {
    ...
    sendCode() {
	  ...
	  params["country"] = "中国";
	  this.settime();
	  reg.test(params["phone"]) && this.$http.post(this.host + "/uc/mobile/code", JSON.stringify(params)).then(response => {
	        var resp = response.body;
